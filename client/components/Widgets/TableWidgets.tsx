            ...
            <ul className='list-filter'>
                {
                    columns.map((item, i) => {
                        return (<li key={i} className='flex-r'>
                            <input type="checkbox" name="list-filter" id={`table-filter-${i}`} value={item.key}/>
                ...
                </div> 
                {
                    hasFilter&&(
                        <div className="search-widget flex-r">
                            {
                                data&&(<div className="filter-property flex-c">
                            ...
                            <div className="input-group flex-r">
                                <input type="text" name="table-search" placeholder='Search'/>
                                <button>
                ...
                <tbody>
                    {
                        data&&data.map((item, index) => {
                            return <_rowTableWidget rowData={item} key={index} columns={columns}/>
                        })
                    }
                </tbody>
            </table>
